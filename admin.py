...
ADMIN_BOT_TOKEN = "8545261117:AAESD6GOHjSbhJi3XYW9NTkgA0AlFO1Mqko"
...
def start(message):
    ...
    bot.reply_to(
        message,
        "🔧 **АДМИН-ПАНЕЛЬ**\n\nОтправь мне файл для обновления: main.py, admin.py, client.bat",
        parse_mode='Markdown',
...
def update_menu_callback(call):
    ...
    keyboard.add(
        InlineKeyboardButton("📦 main.py", callback_data="update_main"),
        InlineKeyboardButton("🔧 admin.py", callback_data="update_admin"),
        InlineKeyboardButton("📄 client.bat", callback_data="update_client"),
...
def handle_document(message):
    ...
    allowed = ["main.py", "admin.py", "client.bat"]
    if file_name not in allowed:
        bot.reply_to(message, "❌ Можно обновлять только: main.py, admin.py, client.bat")
        return
